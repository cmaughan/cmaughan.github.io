...
Using custom debug APIs from Microsoft, I built a simple C++/Windows application that showed the contents of the shader registers, inputs and constants.  You could step through the shader instruction by instruction and watch values change, which was extremely useful when the alternative was staring at assembly and hoping your math had behaved.
