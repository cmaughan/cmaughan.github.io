...
The main view combines a detailed 3D Earth with a live satellite catalog, propagated orbits, stars, constellation figures and boundaries, and a proper day/night terminator. It can also switch to a flat map or a ground-observer sky view, with controls for moving through time and filtering the catalog by object and orbit type.
