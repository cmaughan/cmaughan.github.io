...
The examples shown here implement diffuse and specular ray tracing, along with some simple antialiasing to improve the final image.  Without antialiasing they run in real time, and you can walk around the objects.  The repo includes versions in several languages, which is handy for comparing the different implementations.
