...
The host was written in C++ and Objective-C, with the server running Ruby on Rails on Heroku. It was a nice little full-stack project: mobile UI, rules engines for several classic games, remote matchmaking, etc.
