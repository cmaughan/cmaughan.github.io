...
I added a simple API to the Sonic Pi codebase.
...
The UI is intended as a test and demo, not a replacement for the existing Sonic Pi API.  The useful part is the bridge between live music and live graphics: Sonic Pi makes the sound, the FFT turns it into data, and the shader responds to it.
